    ...
    <main className="container" style={{ maxWidth: "1200px", margin: "40px auto", padding: "0 20px" }}><br/>
        ...
        <section style={{ marginTop: "60px", background: "#ffffff", borderRadius: "16px",padding: "30px", 
            ...
            <ul style={{ lineHeight: "1.8", color: "#374151", paddingLeft: "20px", fontSize: "20px", listStylePosition: "inside" }}>
                ...
                <li>ยกเลิกการจองต้องแจ้งอย่างน้อย 1 ชั่วโมง</li>
                ...
                <li>ห้ามนำรองเท้าที่เปียกหรือสกปรกเข้ามาในสนาม</li>
                <li>ผู้เล่นต้องเตรียมไม้แบดและลูกขนไก่มาเอง หากลูกค้าไม่มีไม้แบด ทางสนามมีบริการเช่าไม้แบด 50 บาท/ไม้ ส่วนบูกขนไก่มีวางจำหน่ายให้หลายราคาและหลายแบบ</li>
                
                <p style={{fontWeight: "600", fontSize: "30px"}}>มารยาทการใช้สนาม</p>
                <li>ห้ามนำอาหารและเครื่องดื่ม (ยกเว้นน้ำเปล่า) เข้ามาในสนาม</li>
                <li>ห้ามสูบบุหรี่หรือดื่มแอลกอฮอล์ในพื้นที่สนาม</li>
                <li>กรุณาเก็บขยะและอุปกรณ์ส่วนตัวหลังใช้งานทุกครั้ง</li>
                
                <p style={{fontWeight: "600", fontSize: "30px"}}>มารยาทการใช้สนาม</p>
                <li>หากมีอาการบาดเจ็บ กรุณาแจ้งเจ้าหน้าที่ทันที</li>
                <li>ผู้เล่นต้องรับผิดชอบต่อทรัพย์สินส่วนตัวและอุปกรณ์ที่นำมาใช้เอง</li>
            </ul><br/>
        </section>
